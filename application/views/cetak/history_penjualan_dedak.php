...
<body>
	...
	<table class="isi" style="width: 100%; border: 1px solid black;border-collapse: collapse;">
		...
		<tbody>
			...
			?>
				<tr>
					...
					<td align="center"><?= $value['kode_slip'] ?></td>
					<td align="center"><?= $value['nama_relasi'] ?></td>
					<td align="center"><?= date('d-M-Y', strtotime($value['tanggal'])) ?></td>
					<td align="center"><?= number_format($value['netto2']) ?></td>
		...
		<tfoot style="border-top: 1px solid black;">
			<tr>
				<td colspan="5" align="center" style="border-right: 1px solid black;">Grand Total</td>

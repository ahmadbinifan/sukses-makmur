        	...
        	<div class="sidebar">
        		...
        		<nav class="mt-2">
        			<ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        				...
        				<li class="nav-item <?php if ($this->uri->segment('1') == "cashier") {
												echo 'menu-open';
											}
											if ($this->uri->segment('1') == "cashier_dedak") {
												echo 'menu-open';
											} ?>">
        					<a href="<?= base_url('cashier') ?>" class="nav-link <?php if ($this->uri->segment('1') == "cashier") {
																						echo 'active';
																					} ?>
                                                                                    <?php if ($this->uri->segment('1') == "cashier_dedak") {
																						echo 'active';
																					} ?>">
        					...
        					<ul class="nav nav-treeview">
        						...
        						<li class="nav-item">
        							<a href="<?= base_url('cashier_dedak') ?>" class="nav-link <?php if ($this->uri->segment('1') == "cashier_dedak") {
																									echo 'active';
																								} ?>">
        								<i class="far fa-circle nav-icon"></i>
        								<p>Penjualan Dedak</p>
        				...
        				<?php if ($this->session->userdata('level') == "admin") { ?>
        					...
        					<li class="nav-item <?php if ($this->uri->segment(1) == "Data_Barang" || $this->uri->segment(1) == "Satuan" || $this->uri->segment(1) == "Kategori" || $this->uri->segment(1) == "History_Penjualan" || $this->uri->segment(1) == "History_Penjualan_Dedak" || $this->uri->segment(1) == "Data_Karyawan") {
													echo 'menu-open';
												} ?>">
        						<a href="#" class="nav-link <?php if ($this->uri->segment(1) == "Data_Barang" || $this->uri->segment(1) == "Satuan" || $this->uri->segment(1) == "Kategori" || $this->uri->segment(1) == "History_Penjualan" || $this->uri->segment(1) == "History_Penjualan_Dedak" || $this->uri->segment(1) == "Data_Karyawan") {
																echo 'active';
															} ?>">
        							<i class="nav-icon fas fa-tachometer-alt"></i>
        							<p>
        						...
        						<ul class="nav nav-treeview">
        							...
        							<li class="nav-item <?php if ($this->uri->segment('1') == "History_Penjualan" || $this->uri->segment('1') == "History_Penjualan_Dedak") {
															echo "menu-open";
														} ?> ">
        								<a href="#" class="nav-link <?php if ($this->uri->segment('1') == "History_Penjualan" || $this->uri->segment('1') == "History_Penjualan_Dedak") {
																		echo "active";
																	} ?>">
        									<i class="far fa-circle nav-icon"></i>
        									<p>History</p>
        								...
        								<ul class="nav nav-treeview">
        									...
        									<li class="nav-item">
        										<a href="<?= base_url('History_Penjualan_Dedak') ?>" class="nav-link  <?php if ($this->uri->segment('1') == "History_Penjualan_Dedak") {
																															echo 'active';
																														} ?>">
        											<i class="far fa-dot-circle nav-icon"></i>
        											<p>Penjualan Dedak</p>
